...
public class ChasseAuxPokemons {
	...
	public static void main(String[] args) {
		...
		try(FileReader lecteur = new FileReader("C:/Users/crist/eclipse-workspace/TP11et12/src/tp11et12/pokedexComplet.txt")){
		...
		try(FileReader lecteur = new FileReader("C:/Users/crist/eclipse-workspace/TP11et12/src/tp11et12/InputFile.txt")){
			Scanner s = new Scanner(lecteur);
			while(s.hasNext()) {
				String name = s.next();
				String type = s.next();
			...
			for (int j = 0; j<tableauNourriture.length; j++) {
				...
				if (generer) {
					...
					if (reponse.equals("oui")) {
						moi.ajouterItem(nourritureGeneree[j]);
					}
				}
